          ...
          >
              ...
              >
                <div className="px-4 pb-6 pt-4 space-y-4 border-t border-gray-300 mt-2">
                  ...
                  >
                    <Link href="/paquetes" onClick={() => setIsMobileMenuOpen(false)} className="flex items-center justify-between py-4 text-[#282828] hover:text-[#CCFF00] transition">
                      <span className="font-medium text-lg md:text-xl">Proyectos cerrados</span>
                      <span className="text-gray-500 text-base md:text-lg">(07)</span>
                    </Link>
                  </motion.div>
                  <div className="h-px bg-gray-300"></div>
                  <motion.div
